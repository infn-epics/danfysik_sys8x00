...
# NOTE: deliberately NOT sending REM this time - REM is not in this unit's
# own command index (only CMD/CMDSTATE, which are read-only). Testing
# whether skipping it changes anything.

send("CMD")
read_reply("CMD baseline")
